...
export class AgentPlanner {
   ...
   * If no prospects are supplied, Nyx queues discovery and waits for sourced candidates.
   */
  public async planObjectiveTasks(
    ...
    for (const prospect of prospects) {
      ...
      // Never invent a contact address. Draft only for a supplied/public email.
      if (contactEmail) {
