...
import { researchGoogleBusiness } from './research/googleBusiness.js';
...
export function registerSalesRuntimeTools(): void {
  ...
  toolRegistry.registerTool({
    ...
    description: 'Research a supplied Google Business or Google Maps URL and return only fields actually observed on the public page.',
    approvalPolicy: 'AUTO_APPROVED',
    timeoutMs: 20000,
    retryBehavior: { maxAttempts: 2, backoffMs: 1500 },
    ...
    execute: async (args: any) => researchGoogleBusiness(String(args.url || args.google_business_url || args.query))
  });
